...
public class JwtServiceTest {
    ...
    public void testInvalidToken_WithModifiedToken_ShouldReturnTrue() {
        ...
        // Act - Modify token to corrupt the signature
        String invalidToken = token.substring(0, token.lastIndexOf('.') + 1) + "corruptedSignature";

        // This should throw a SignatureException - TestNG will check for this
        assertEquals(invalidToken, token);;
    }
